/**
 * FILE: MineL2Shape.js
 * PERCORSO /Codice/sgad/clienttier/view/graphicobjects/components/worldcomponentshape/MineL2Shape.js
...
MineL2Shape.prototype = new WorldComponentShapeImg();

//Costruttore della classe.
MineL2Shape.prototype.constructor = MineL2Shape;

/**
 * Classe per la memorizzazione dell'immagine e del poligono per la rappresentazione di una miniera di livello 2.
 * @extends WorldComponentShapeImg
 * @constructor
 */
function MineL2Shape() {
	...
	this.image.src = "canvas/images/Miniera_L2.png";
}
