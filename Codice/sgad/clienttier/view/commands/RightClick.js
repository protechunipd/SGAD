/**
 * FILE: RightClick.js
 * PERCORSO /Codice/sgad/clienttier/view/commands/RightClick.js
...
//Eredita da Command.
RightClick.prototype = new Command();

//Costruttore della classe.
RightClick.prototype.constructor = RightClick;

/**
 * Classe per la gestione di un evento, di tipo click destro del mouse, nell'area di gioco.
 * @extends Command
 * @constructor
 */
function RightClick() {
 ...
 * @return {void}
 */
RightClick.prototype.execute = function (event, iterator) {
	var clicked = false;
	var object = null;
	var posx = 0;
	var posy = 0;
	...
	if (clicked)
		object.onRightClick(); //eseguo l'evento sull'oggetto
};