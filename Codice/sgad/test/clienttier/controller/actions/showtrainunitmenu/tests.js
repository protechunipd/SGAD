test("Test su ShowTrainUnitMenu", function() {
    ...
    var action = new ShowTrainUnitMenu(new BuildingPossession(new BuildingWithLevel(new Bonus("bon1", 20.30, 2), new Cost(10, null), 2, "Stalla", buildwithlev1, new ProductedResource(10,5,2, new Resource("Pera")), arrunit, 2, true, true),true, new Position(2,2), 20, 20, new UnitInProgress(20, new Unit("Cavaliere", 20, 20, new Cost(20, null)),20)),new Unit("Cavaliere", 20, 20, null));
    action.performAction();

    deepEqual(true, true, "Eseguita azione ShowTrainUnitMenu");
});