test("Test su LoadGeneralData", function () {
	...
	loadGeneralData.setActionDatas(datas);
	...
	deepEqual(dataFactory.getResource("Pozioni").getResourceName(), "Pozioni", "Test su getResource()");
	deepEqual(dataFactory.getResource("Oro").getResourceName(), "Oro", "Test su getResource()");
	deepEqual(dataFactory.getUnit("Lavoratore").getAttack(), 0, "Test su getUnit()");
	deepEqual(dataFactory.getUnit("Carro d'assalto").getAttack(), 45, "Test su getUnit()");
	deepEqual(dataFactory.getBuilding("CasermaL3")["cost"]["quantityResource"][0]["resource"]["resourceName"], "Oro", "Test su getBuilding()");
});