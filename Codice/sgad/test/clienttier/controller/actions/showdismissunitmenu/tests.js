test("Test su ShowDismissUnitMenu", function(){
    ...
    var action = new ShowDismissUnitMenu(new BuildingPossession(new BuildingWithLevel(new Bonus("bon1", 20.30, 2), new Cost(10, null), 2, "Stalla", null, new ProductedResource(10,5,2, new Resource("Pera")), arrunit, 2, true, true),true, new Position(2,2), 20, 20, new UnitInProgress(20, new Unit("Cavaliere", 20, 20, null),20)),new Unit("Cavaliere", 20, 20, null))

    action.performAction();

    deepEqual(true, true, "Eseguita azione ShowDismissUnitMenu");
