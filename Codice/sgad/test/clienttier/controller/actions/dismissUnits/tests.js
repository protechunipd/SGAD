test("Test su DismissUnits", function () {
    ...
    deepEqual(UserDataManager.getInstance().getUserData().getUnitPossession("Cavaliere").getQuantity(), 8, "Test su getUnitPossession()");
    deepEqual(UserDataManager.getInstance().getUserData().getUnitPossession("Fante").getQuantity(), 4, "Test su getUnitPossession()");
    var action1 = new DismissUnits(DataFactory.getInstance().getUnit("Cavaliere"), 3);
    var action2 = new DismissUnits(DataFactory.getInstance().getUnit("Fante"), 1);
    try {
        action1.setActionDatas(false);
        action2.setActionDatas(false);
    } catch(e) {}
    action1.setActionDatas(true);
    action2.setActionDatas(true);
    action1.performAction();
    action2.performAction();
    notDeepEqual(UserDataManager.getInstance().getUserData().getUnitPossession("Cavaliere").getQuantity(), 8, "Test su getUnitPossession()");
    notDeepEqual(UserDataManager.getInstance().getUserData().getUnitPossession("Fante").getQuantity(), 4, "Test su getUnitPossession()");
});