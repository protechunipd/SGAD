test("Test su ShowTileContextualMenu", function() {
    ...
    var action = new ShowTileContextualMenu(new TileComponent(new Position(20,20)));
    action.performAction();

    deepEqual(true, true, "Azione ShowTileContextualMenu eseguita");
