test("Test su BackupManager", function() {
    ...
    deepEqual(bck.getUserDataBackup(), manager.getUserData(), "Test su getInstance e getUserDataBackup (true)");

    usr1.addBuildingPossession(new BuildingPossession(new BuildingWithLevel(null, null, 2, "Miniera", null, null, null, 2,true, true), true, new Position(2,1), 20, 20, null))
    manager.setUserData(usr1);

    bck.restoreDatas();
    deepEqual(bck.getUserDataBackup(), manager.getUserData(), "Test su restoreDatas");
