/**
 * FILE: RequestWorkerTimeout.scala
...
/**
 * Classe che rappresenta il messaggio di timeout verso il WorkerActor a cui l'attore deve reagire uccidendosi.
 */
case object WorkerActorTimeoutMessage
