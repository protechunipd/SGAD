/**
 * FILE: ToPublisherAndUserInternalRequest.scala
...
/**
 * Classe per la gestione delle richieste interne tra user.
 * @constructor
 ...
 */
case class ToPublisherAndUserInternalRequest(sender: ActorRef, user: String, operation: String, data: String)
